...
contract SuperFrenManagerTest is BaseVaultTest, SuperFrenManagerEvents {
    ...
    // Contracts
    SuperFrenManager superFrenManager;
    ...
    function setUp() public {
        // Deploy contracts
        superFrenManager = new SuperFrenManager();
        ...
        // Setup roles
        vm.startPrank(owner);
        superFrenManager.grantRoles(owner, OWNER_ROLE);
        superFrenManager.grantRoles(manager, MANAGER_ROLE);
        vm.stopPrank();
        
        // Label addresses for clearer trace outputs
    ...
    function test_RemoveNFTContract() public {
        ...
        assertFalse(superFrenManager.approvedNFTContracts(address(mockSuperFrens)), "NFT contract should be removed");
    }
    ...
    function test_RegisterFunction() public {
        ...
        assertEq(
            superFrenManager.functionNames(address(mockExternalContract), functionSelector),
            "testFunction",
    ...
    function test_RemoveFunction() public {
        ...
        assertEq(
            superFrenManager.functionNames(address(mockExternalContract), functionSelector),
            "",
            "Function name should be cleared"
        );
    }
    ...
    function test_ExecuteFunction() public {
        ...
        (bool success, bytes memory returnData) = superFrenManager.executeFunction(
    ...
    function test_OnERC1155Received() public {
        ...
        assertEq(
            response,
            superFrenManager.onERC1155Received.selector,
    ...
    function test_OnERC1155BatchReceived() public {
        ...
        assertEq(
            response,
            superFrenManager.onERC1155BatchReceived.selector,
            "Should return correct selector"
        );
    }
    ...
    function test_EmergencyWithdrawERC20() public {
        ...
        emit EmergencyWithdrawalSuperFren(address(mockERC20), user, amount);
        
        superFrenManager.emergencyWithdrawERC20(address(mockERC20), user, amount);
        
        // Check that the tokens were transferred
        assertEq(
            mockERC20.balanceOf(user),
            amount,
            "User should have received the withdrawn tokens"
        );
    }
    ...
    function test_EmergencyWithdrawERC20_NotOwner() public {
        ...
        vm.prank(user);
        vm.expectRevert();
        superFrenManager.emergencyWithdrawERC20(address(mockERC20), user, 500);
    }
    ...
    function test_EmergencyWithdrawERC1155() public {
        ...
        vm.prank(owner);
        vm.expectEmit(true, true, false, true);
        emit EmergencyWithdrawalSuperFren(address(mockSuperFrens), user, amount);
        
        superFrenManager.emergencyWithdrawERC1155(address(mockSuperFrens), user, id, amount);
        
        // Check that the NFTs were transferred
        assertEq(
            mockSuperFrens.balanceOf(user, id),
            amount,
            "User should have received the withdrawn NFTs"
        );
    }
    ...
    function test_EmergencyWithdrawERC1155_NotOwner() public {
        ...
        vm.prank(user);
        vm.expectRevert();
        superFrenManager.emergencyWithdrawERC1155(address(mockSuperFrens), user, id, 1);
    }
