...
contract SuperFrenManagerTest is BaseVaultTest, MetaVaultEvents {
    ...
    function test_AddNFTContract() public {
        ...
        console2.log(
            "### ~ vault.t.sol:80 ~ test_AddNFTContract ~ address(mockSuperFrens):", address(mockSuperFrens)
        );
        vault.addNFTContract(address(mockSuperFrens));

        assertTrue(vault.approvedNFTContracts(address(mockSuperFrens)), "NFT contract should be approved");
    }
    ...
    function test_AddNFTContract_ZeroAddress() public {
        ...
        vault.addNFTContract(address(0));
    }
    ...
    function test_RemoveNFTContract() public {
        ...
        // Then remove it
        vm.prank(users.alice);
        vault.removeNFTContract(address(mockSuperFrens));

        assertFalse(vault.approvedNFTContracts(address(mockSuperFrens)), "NFT contract should beremoved");
    }
    ...
    function test_RegisterFunction() public {
        ...
        vault.registerFunction(address(mockExternalContract), functionSelector, "testFunction");

        assertTrue(
            vault.registeredFunctions(address(mockExternalContract), functionSelector),
    ...
    function test_RegisterFunction_ZeroAddress() public {
        ...
        vm.prank(users.alice);
        vm.expectRevert(abi.encodeWithSignature("InvalidZeroAddress()"));
        vault.registerFunction(address(0), functionSelector, "testFunction");
    }
    ...
    function test_RemoveFunction() public {
        ...
        vault.removeFunction(address(mockExternalContract), functionSelector);
    ...
    function test_ExecuteFunction() public {
        ...
        (bool success, bytes memory returnData) =
            vault.executeFunction(address(mockExternalContract), callData, 0);
    ...
    function test_ExecuteFunction_CallFails() public {
        ...
        // Register the function
        vm.prank(users.alice);
        vault.registerFunction(address(mockExternalContract), functionSelector, "failingFunction");
    ...
    function test_ClaimNFT() public {
        ...
        vault.claimNFT(address(mockSuperFrens), editionId, tierId, proof);
    ...
    //     vm.prank(users.alice);
    //     vault.batchClaimNFTs(address(mockSuperFrens), editionIds, tierIds, proofs);
    ...
    //     vault.forgeNFT(address(mockSuperFrens), tierId);
    ...
    //     vm.prank(users.alice);
    //     vault.batchForgeNFTs(address(mockSuperFrens), tierIds);
    ...
    //     // Check the balance
    //     uint256 balance = vault.getNFTBalance(address(mockSuperFrens), tierId);
    ...
    //     bool isComplete = vault.hasCompleteNFTSet(address(mockSuperFrens), startTierId, count);
    ...
    //     bytes4 response = vault.onERC1155Received(address(this), address(this), id, value, "");

    //     assertEq(response, vault.onERC1155Received.selector, "Should return correct selector");
    // }
    ...
    //     bytes4 response = vault.onERC1155BatchReceived(address(this), address(this), ids, values, "");

    //     assertEq(response, vault.onERC1155BatchReceived.selector, "Should return correct selector");
    // }

    // function test_SupportsInterface() public {
    //     // ERC1155 receiver interface ID
    //     bool supportsERC1155Receiver = vault.supportsInterface(0x4e2312e0);
    //     assertTrue(supportsERC1155Receiver, "Should support ERC1155 receiver interface");

    //     // Random interface ID
    //     bool supportsRandomInterface = vault.supportsInterface(0x12345678);
    ...
    //     vault.emergencyWithdrawERC20(address(mockERC20), (users.alice), amount);
    ...
    //     vm.prank(users.bob);
    //     vm.expectRevert();
    //     vault.emergencyWithdrawERC20(address(mockERC20), (users.bob), 500);
    // }
    ...
    //     vm.prank(users.alice);
    //     vm.expectRevert(abi.encodeWithSignature("InvalidZeroAddress()"));
    //     vault.emergencyWithdrawERC20(address(mockERC20), address(0), 500);
    // }
    ...
    //     vault.emergencyWithdrawERC1155(address(mockSuperFrens), (users.bob), id, amount);
    ...
    //     vm.prank(users.bob);
    //     vm.expectRevert();
    //     vault.emergencyWithdrawERC1155(address(mockSuperFrens), (users.bob), id, 1);
    // }
    ...
    //     vm.prank(users.alice);
    //     vm.expectRevert(abi.encodeWithSignature("InvalidZeroAddress()"));
    //     vault.emergencyWithdrawERC1155(address(mockSuperFrens), address(0), id, 1);
    // }
}
